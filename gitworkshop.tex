...
% disable ligatures to ensure that
% hyphens (-) and especialy -- and ---
% are shown as is and not rendert as en/em dash
% important for cmds
  ...
  \else
    ...
    \setbeamertemplate{footline}[text line]{%
      \parbox{\linewidth}{\vspace*{-12pt}\textcolor{lightgray}{\inserttitle{} {\normalsize\ttfamily\textcopyright}\
        https://github.com/segfault-trainings - Licensed for: CC-BY-SA-4.0
    ...
    \setbeamertemplate{frametitle}
    {
        ...
        \begin{beamercolorbox}[sep=0.01cm,ht=1.8em,wd=\paperwidth]{frametitle}
          ...
          %\vskip-0.8ex%
          \hfill$\vcenter{\hbox{\includegraphics{assets/diagrams/git-logo-small.pdf}}}$
        \end{beamercolorbox}
    }
...
{
  \vspace{.6cm}
  \center \includegraphics{assets/diagrams/git-logo-2color.pdf}
  \vbox{}
  \vfill
  \begingroup
    \centering
