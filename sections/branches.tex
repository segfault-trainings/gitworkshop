...
\begin{frame}[fragile]
  ...
  Commit your changes:
  \begin{lstlisting}
(*\textcolor[HTML]{18B2B2}{(third-moon)}*) $ (*\textcolor[HTML]{0000AA}{git commit -a -m "add a white moon between the blue and green moon"}*)
\end{lstlisting}
...
\end{lstlisting}
  ...
  Commit your changes:
  \begin{lstlisting}
(*\textcolor[HTML]{18B2B2}{(master)}*) $ (*\textcolor[HTML]{0000AA}{git commit -a -m "add prerequisites subsection"}*)
\end{lstlisting}
