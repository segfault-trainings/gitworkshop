...
\begin{frame}
  ...
  \textbf{Why do we use Version Control Systems?}
  \pause
  \\
  \begin{itemize}
    \item complete change history of \textbf{every} file
    \item navigate in history
    \item traceability
    \item working in a team (branching, merging, ...)
    \item ...
  \end{itemize}
\end{frame}
