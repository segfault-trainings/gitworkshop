...
\subsection{Best practice Commit Message}
\begin{frame}[fragile]
  \subslidetitle
...
\begin{frame}[fragile]
 ...
 This is sanbox playground for learning git.

 ## Dependencies

 ```
 sudo apt-get update
 sudo apt-get install git tig gitgui gitk
 ```
...
\begin{frame}[fragile]
  \subslidetitle
  But hey no problem we can quickly change the last commit using \cmd{git commit --amend}:

  Let's correct the typo and commit using \cmd{--amend}
 \begin{lstlisting}
$ (*\textcolor[HTML]{0000AA}{git diff}*)
diff --git a/README b/README
index 4fe2b4b..737ee40 100644
--- a/README
+++ b/README
@@ -8,5 +8,5 @@ This is sanbox playground for learning git.

```
sudo apt-get update
-sudo apt-get install git tig gitgui gitk
+sudo apt-get install git tig git-gui gitk
```

$ (*\textcolor[HTML]{0000AA}{git commit -a --amend}*)
