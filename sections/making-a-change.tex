...
\begin{frame}[fragile]
  ...
  \begin{tabular}{lp{8cm}}
    ...
    \pause
    \textbf{CommitDate} & Date gets changed every time the commit is being modified (\cmd{git rebase})\\
    \pause
  ...
  \vspace{0.5em}
  Note: Your commit messages reveal whether you are a good collaborator or not.
\end{frame}
