...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item Collaborate on a Git repository
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \centerline{\includegraphics[width=\textwidth]{../assets/images/gitmoon-collab.png}}
...
\begin{frame}[fragile]
  \subslidetitle
  Forking Workflow
  \centerline{\includegraphics[width=\textwidth]{assets/diagrams/git-forking-workflow-slide1.png}}
...
\begin{frame}[fragile]
  ...
  Let's create a Fork from the \textbf{gitmoon-collab} project using \href{https://github.com}{GitHub}:

    \vspace{2em}
    \centerline{\includegraphics[width=\textwidth]{../assets/images/github-forking.png}}

    \vspace{1em}
  Note: the repository is at \url{https://github.com/segfault-trainings/gitmoon-collab}.
...
\begin{frame}[fragile]
  ...
  \begin{lstlisting}
$ cd ~
$ (*\textcolor[HTML]{0000AA}{git clone https://github.com/<YOUR USERNAME>/gitmoon-collab.git}*)
...

$ (*\textcolor[HTML]{0000AA}{git remote show origin}*)
* remote origin
  Fetch URL: https://github.com/<YOUR USERNAME>/gitmoon-collab.git
  Push  URL: https://github.com/<YOUR USERNAME>/gitmoon-collab.git
  HEAD branch: master
...
\end{lstlisting}
  ...
  \begin{lstlisting}
$ (*\textcolor[HTML]{0000AA}{git add moons/<YOUR NAME>.js}*)
$ (*\textcolor[HTML]{0000AA}{git commit -m "Add new Moon <NAME>"}*)
...
...
To https://github.com/<YOUR USERNAME>/gitmoon-collab.git
...
\begin{frame}[fragile]
  \subslidetitle
  Forking Workflow
  \centerline{\includegraphics[width=\textwidth]{assets/diagrams/git-forking-workflow-slide2.png}}
...
\begin{frame}[fragile]
  ...
  \vspace{2em}
  \centerline{\includegraphics[width=\textwidth]{assets/diagrams/git-forking-workflow-slide3.png}}
...
\begin{frame}[fragile]
  ...
  \vspace{2em}
  \centerline{\includegraphics[width=\textwidth]{assets/diagrams/git-forking-workflow-slide4.png}}
...
\end{lstlisting}
  ...
  \begin{lstlisting}
$ (*\textcolor[HTML]{0000AA}{git remote add upstream https://github.com/segfault-trainings/gitmoon-collab}*)
...
\begin{frame}[fragile]
  ...
  \vspace{2em}
  \centerline{\includegraphics[width=\textwidth]{assets/diagrams/git-forking-workflow-slide5.png}}
