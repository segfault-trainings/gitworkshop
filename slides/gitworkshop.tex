...
\newcommand\handoutmode[1]{
  ...
  \else
    ...
    \lstset{
      basicstyle=\scriptsize\ttfamily\bfseries\color{green}, %\tiny\ttfamily,
      tabsize=2,
      extendedchars=true,
      breaklines=true,
      frame=single,
      ...
      commentstyle=\color{red},
      keywordstyle=\color{blue},
      rulecolor=\color{listingbackground}
    %  language=bash
    }
    %\lstloadlanguages{bash}
...
\newcommand{\subslidetitle}{\frametitle{\thesection.\thesubsection\ \secname:\ \subsecname}\vspace{1em}}
\newcommand{\subsubslidetitle}{\frametitle{\thesection.\thesubsection.\thesubsubsection\ \subsecname:\ \subsubsecname}\vspace{1em}}
